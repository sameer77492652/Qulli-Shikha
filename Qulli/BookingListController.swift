...
class BookingListController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        print("BASE_URL_TEXT", Constants.LOGIN)
      ...
      menuButton.addTarget(revealViewController, action: #selector(SWRevealViewController.revealToggle(_:)), for: .touchUpInside)
       ...
       self.title = "Qulli"
        ...
        Alamofire.request(Constants.BOOKINGS, method: .get, parameters: nil, encoding: URLEncoding.default, headers: params).responseJSON { (response:DataResponse<Any>) in
