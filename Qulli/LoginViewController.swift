...
class LoginViewController: UIViewController , UITextFieldDelegate {
    ...
    @IBAction func loginBtnAction(_ sender: AnyObject)
    {
        ...
        Alamofire.request(Constants.LOGIN, method: .post, parameters: parameter, encoding: URLEncoding.default, headers: params).responseJSON { (response:DataResponse<Any>) in
    ...
    @IBAction func ForgotBtnAction(_ sender: AnyObject)
    {
        ...
        let okAction = UIAlertAction(title: "OK", style: UIAlertActionStyle.default) { (result : UIAlertAction) -> Void in
            ...
            else
            {
                ...
                Alamofire.request(Constants.FORGOT_PASSWORD, method: .post, parameters: parameter, encoding: URLEncoding.default, headers: params).responseJSON { (response:DataResponse<Any>) in
