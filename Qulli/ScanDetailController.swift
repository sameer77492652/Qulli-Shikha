...
class ScanDetailController: UIViewController , UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        Alamofire.request("http://qulli.co/api/v1.0/driver/scan", method: .post, parameters: parameter, encoding: URLEncoding.default, headers: params).responseJSON { (response:DataResponse<Any>) in
     ...
     @IBAction func updatebookingstatus(_ sender: AnyObject)
    {
        ...
        Alamofire.request("http://qulli.co/api/v1.0/driver/booking/update", method: .post, parameters: parameter, encoding: URLEncoding.default, headers: params).responseJSON { (response:DataResponse<Any>) in
